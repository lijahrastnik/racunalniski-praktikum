...
\begin{magic}{3}{Kvadrat Lou Shu}{table:loshu}
    4 & 9 & 2 \\\hline
    3 & 5 & 7 \\\hline
    8 & 1 & 6 \\\hline
\end{magic}    
...
\begin{figure}[!ht]
   \centering
   \caption{Pasijonskaa fasada, Sagrada Família}
   \label{fig:sagrada}
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{table:števila}.
% sklic: table:stevila
